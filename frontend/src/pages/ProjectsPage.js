...
const ALL_PROJECTS = [
  ...
  { id: '4', client_name: 'Devtraco Plus Limited', project_type: 'Preliminary Environmental Reports & Waste Management Plans', location: 'Accra, Ghana', summary: 'Preliminary Environmental Report and Waste Management Plan for 10-storey NoVA project at Roman Ridge. Environmental Assessment and permit acquisition for Multi-Family Housing at Lashibi, 4-Storey Mixed Use Project in West Cantonments, and East Cantonments Village project.', industry: 'Built Environment', contact: 'Lawrence Asante, Business Dev. Manager' },
